...
(function() {
    var l, j, k, m, p, n, q, r, o = [].slice,
        ...
        s = function(h, a) {
            ...
            for (var b in a) u.call(a, b) && (h[b] = a[b]);
            c.prototype = a.prototype;
            h.prototype = new c;
            h.__super__ = a.prototype;
            return h
        };
    j = document.getElementById("jsrepl-script");
    if (j != null) l = j.src.split("/").slice(0, -1).join("/"), p = "" + l + "/sandbox.html";
    ...
    m = function() {
        function h() {
            ...
            window.onload = function(c) {
                return function() {
                    ...
                    e = c.loadfns;
                    g = [];
                    for (a = 0, d = e.length; a < d; a++) b = e[a], g.push(b());
                    return g
                }
            }(this);
            this.iframe = null
        ...
        h.prototype.createSandbox = function(a) {
            this.iframe != null && this.body.removeChild(this.iframe);
            this.iframe = document.createElement("iframe");
            this.iframe.src = p;
            this.iframe.style.display = "none";
            this.iframe.onload = function(c) {
                return function() {
    ...
    j = function() {
        ...
        h.prototype.on =
            function(a, c) {
                ...
                if (typeof c === "function") {
                    a = this.makeArray(a);
                    e = [];
                    for (f = 0, d = a.length; f < d; f++) b = a[f], this.listeners[b] == null ? e.push(this.listeners[b] = [c]) : e.push(this.listeners[b].push(c));
                    return e
                }
            };
        h.prototype.off = function(a, c) {
            var b, f, d, e, g, a = this.makeArray(a);
            g = [];
            for (d = 0, e = a.length; d < e; d++) b = a[d], f = this.listeners[b], f != null && (c != null ? (b = f.indexOf(c), b > -1 ? g.push(f.splice(b, 1)) : g.push(void 0)) : g.push(this.listeners[b] = []));
            return g
        };
        h.prototype.fire = function(a, c) {
            var b, f, d, e, c = this.makeArray(c);
            f = this.listeners[a];
            if (f != null) {
                c.push(a);
                var g;
                g = [];
                for (d = 0, e = f.length; d < e; d++) b = f[d], g.push(b);
                e = [];
                for (f = 0, d = g.length; f < d; f++) b = g[f], e.push(b.apply(this, c));
                return e
            }
        };
        h.prototype.once = function(a, c) {
            ...
            b = function(g) {
                return function() {
                    var f, d, e, h;
                    f = 1 <= arguments.length ? o.call(arguments, 0) : [];
                    for (e = 0, h = a.length; e < h; e++) d = a[e], g.off(d, b);
                    return c.apply(null, f)
                }
            }(this);
            g = [];
            for (d = 0, e = a.length; d < e; d++) f = a[d], g.push(this.on(f, b));
            return g
        };
        return h
    }();
    ...
    n = function(h) {
        function a(c, b, a) {
            ...
            this.input_server = b;
            a == null && (a = {});
            this.onmsg = i(this.onmsg, this);
            var e, g, h;
            h = [];
            for (e = 0, g = c.length; e < g; e++) b = c[e], h.push(l + "/" + b);
            this.baseScripts = h;
            this.loader = new m;
            for (d in a) c = a[d], typeof c === "function" && (a[d] = [c]);
            this.listeners = a
        }
        s(a, h);
        ...
        a.prototype.load = function(a, b) {
            ...
            e = function(a) {
                return function() {
                    ...
                    if (a.input_server != null) return a.post({
            ...
            return !r || !b ? this.loader.createSandbox(function(a) {
                return function(b) {
                    a.worker = b;
                    a.workerIsIframe = true;
                    window.addEventListener("message", a.onmsg, false);
                    return e()
                }
            }(this)) : (this.worker = new Worker(d), this.workerIsIframe = false, this.worker.addEventListener("message", this.onmsg,
                false), e())
        };
    ...
    k = function(h) {
        function a(c) {
            ...
            e = b.input_server;
            this.getLangConfig = i(this.getLangConfig, this);
            this.rawEval = i(this.rawEval, this);
            this.eval = i(this.eval, this);
            this.checkLineEnd = i(this.checkLineEnd, this);
            this.loadLanguage = i(this.loadLanguage, this);
            this.off = i(this.off, this);
            this.on = i(this.on, this);
            a.__super__.constructor.call(this);
            window.openDatabase != null && (f = openDatabase("replit_input", "1.0",
                "Emscripted input", 1024), f.transaction(function(a) {
                a.executeSql("DROP TABLE IF EXISTS input");
                return a.executeSql("CREATE TABLE input (text)")
            }));
            e == null && (e = {});
            e.input_id = Math.floor(Math.random() * 9007199254740992) + 1;
            this.lang = null;
            this.on("input", d);
            b = ["sandbox.js"];
            window.__BAKED_JSREPL_BUILD__ || (b = b.concat(["util/polyfills.js", "util/mtwister.js"]));
            this.sandbox = new n(b, e, {
                output: g,
                input: function(a) {
                    return function() {
                        return a.fire("input", function(b) {
                            return a.sandbox.post({
                                type: "input.write",
                                data: b
                            })
                        })
                ...
                db_input: function(a) {
                    return function() {
                        return a.fire("input", function(b) {
                            a.sandbox.fire("recieved_input", [b]);
                            return f.transaction(function(a) {
                                return a.executeSql("INSERT INTO input (text) VALUES ('" + b + "')", [])
                            })
                        })
                    }
                }(this),
                server_input: function(a) {
                    return function() {
                        return a.fire("input", function(b) {
                            var c, d;
                            a.sandbox.fire("recieved_input", [b]);
                            c = (e.url || "/emscripten/input/") + e.input_id;
                            if (e.cors)
                                if (d = new XMLHttpRequest, "withCredentials" in d) d.open("POST", c, true);
                                else if (typeof XDomainRequest !==
                                "undefined" && XDomainRequest !== null) d = new XDomainRequest, d.open("POST", c);
                            else throw Error("CORS not supported on your browser");
                            else d = new XMLHttpRequest, d.open("POST", c, true);
                            return d.send("input=" + b)
                        })
                    }
                }(this)
            })
        ...
        a.prototype.on = function(c, b) {
            var f, d, e, g, c = this.makeArray(c);
            g = [];
            for (d = 0, e = c.length; d < e; d++) f = c[d], f === "input" ? g.push(a.__super__.on.call(this, "input", b)) : g.push(this.sandbox.on(f, b));
            return g
        };
        a.prototype.off = function(c, b) {
            ...
            for (d = 0, e = c.length; d <
                e; d++) f = c[d], f === "input" ? g.push(a.__super__.off.call(this, "input", b)) : g.push(this.sandbox.off(f, b));
            return g
        };
        a.prototype.loadLanguage = function(c, b, f) {
            var d, e;
            typeof b === "function" && (e = [b, void 0], f = e[0], b = e[1]);
            if (a.prototype.Languages.prototype[c] == null) throw Error("Language " + c + " not supported.");
            this.current_lang_name = c;
            this.lang = a.prototype.Languages.prototype[c];
            if (f != null) this.sandbox.once("ready", f);
            return this.sandbox.load(function() {
                var a, b, c, e;
                c = this.lang.scripts;
                e = [];
                for (a = 0, b = c.length; a <
                    b; a++) d = c[a], typeof d === "object" ? e.push(d[q] || d["default"]) : e.push(d);
                return e
        ...
        a.prototype.eval = function(a, b) {
            var f, d, e, g, h;
            !this.sandbox.workerIsIframe && this.timeout != null && this.timeout.time && this.timeout.callback && (g = null, d = function(a) {
                return function() {
                    a.sandbox.fire("timeout");
                    return a.timeout.callback() ?
                        h() : g = setTimeout(d, a.timeout.time)
                }
            }(this), g = setTimeout(d, this.timeout.time), e = function(a) {
                return function() {
                    var b, c;
                    2 <= arguments.length ? o.call(arguments, 0, c = arguments.length - 1) : c = 0;
                    b = arguments[c++];
                    clearTimeout(g);
                    if (b === "input") return a.once("recieved_input", function() {
                        return g = setTimeout(d, a.timeout.time)
                    }), f()
                }
            }(this), f = function(a) {
                return function() {
                    return a.once(["result", "error", "input"], e)
                }
            }(this), h = function(a) {
                return function() {
                    return a.off(["result", "error", "input"], e)
                }
            }(this), f());
            if (typeof b ===
                "function") this.once(["result", "error"], function() {
                return function() {
                    var a, c, d;
                    a = 2 <= arguments.length ? o.call(arguments, 0, d = arguments.length - 1) : (d = 0, []);
                    c = arguments[d++];
        ...
        a.prototype.getLangConfig = function(c) {
    ...
    k.prototype.__test__ = function() {
        return function() {}
    }();
    k.prototype.__test__.prototype.Loader = m;
    k.prototype.__test__.prototype.EventEmitter = j;
    k.prototype.__test__.prototype.Sandbox = n;
    this.JSREPL = k
}).call(this);
JSREPL.prototype.Languages.prototype = {
    ...
    apl: {
        ...
        scripts: [{
            "default": ["engines/apl-default.js"]
        }],
        includes: [],
        engine: "langs/apl/jsrepl_apl.js",
        minifier: "yui"
    },
    javascript: {
