...
(function (global)
{
	...
	function newContext(e)
	{
		...
		}, n = function (e)
		{
			...
			{}, this.map = e, this.shim = getOwn(o.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0
		}, n.prototype = {
	...
	}(typeof window != "undefined" ? window : this, function (window, noGlobal)
	{
		...
		function defaultPrefilter(e, t, n)
		{
			...
			if (!jQuery.isEmptyObject(c))
			{
				...
				{}), s && (d.hidden = !p), p ? jQuery(e).show() : l.done(function ()
				{
					jQuery(e).hide()
				}), l.done(function ()
				{
		...
		}, jQuery.extend = jQuery.fn.extend = function ()
		{
			...
			{}, u++), typeof o != "object" && !jQuery.isFunction(o) && (o = {}), u === a && (o = this, u--);
			for (; u < a; u++)
		...
		}), jQuery.each(
		{
			...
			siblings: function (e)
			{
				return jQuery.sibling((e.parentNode ||
				{}).firstChild, e)
			},
			children: function (e)
			{
		...
		jQuery.event = {
			...
			add: function (e, t, n, r, i)
			{
				...
				while (f--)
				{
					...
					{}, p = (i ? c.delegateType : c.bindType) || p, c = jQuery.event.special[p] ||
					{}, l = jQuery.extend(
					{
						type: p,
						origType: v,
			...
			remove: function (e, t, n, r, i)
			{
				...
				while (f--)
				{
					...
					c = jQuery.event.special[p] ||
					{}, p = (r ? c.delegateType : c.bindType) || p, h = a[p] || [], u = u[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length;
			...
			trigger: function (e, t, n, r)
			{
				...
				i = 0;
				while ((s = c[i++]) && !e.isPropagationStopped()) e.type = i > 1 ? u : l.bindType || h, f = (data_priv.get(s, "events") ||
				{})[e.type] && data_priv.get(s, "handle"), f && f.apply(s, t), f = a && s[a], f && f.apply && jQuery.acceptData(s) && (e.result = f.apply(s, t), e.result === !1 && e.preventDefault());
			...
			dispatch: function (e)
			{
				...
				while ((i = o[t++]) && !e.isPropagationStopped())
				{
					...
					while ((s = i.handlers[n++]) && !e.isImmediatePropagationStopped())
						if (!e.namespace_re || e.namespace_re.test(s.namespace)) e.handleObj = s, e.data = s.data, r = ((jQuery.event.special[s.origType] ||
						{}).handle || s.handler).apply(i.elem, u), r !== undefined && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation())
				}
			...
			fix: function (e)
			{
				...
				{}), r = o.props ? this.props.concat(o.props) : this.props, e = new jQuery.Event(s), t = r.length;
				...
				(Gt(t) ? Jn : dn)(t, function (t, s)
				{
					...
					if (t && ((u = Gt(t)) || On(t)))
					{
							...
							} if (!o)
						{
							...
							c || (f = u ? Gt(f) ? f : [] : On(f) ? f :
							{}), r.push(t), i.push(f), c || It(f, t, n, r, i)
						}
					}
...
": "u2029"
	...
	function (e, t)
	{
		...
		{
			var n, r, i, s;
			window.mixpanel = t, t._i = [], t.init = function (e, n, r)
			{
				function o(e, t)
				{
					var n = t.split(".");
				...
				t._i.push([e, n, r])
			}, t.__SV = 1.2, n = e.createElement("script"), n.type = "text/javascript", n.async = !0, n.src = ("https:" === e.location.protocol ? "https:" : "http:") + "//cdn.mxpnl.com/libs/mixpanel-2.2.min.js", r = e.getElementsByTagName("script")[0], r.parentNode.insertBefore(n, r)
		}
	}(document, window.mixpanel || []), define("mixpanel", function (e)
	{
		return function ()
		{
			var t, n;
	...
	}(this)), define("utils/analytic", ["lodash", "mixpanel"], function (e, t)
	{
		t.init("01eb2b950ae09a5fdb15a98dcc5ff20e",
		{
			loaded: function ()
			{
				r("page.start")
		...
		var n = function ()
			{
				return typeof t != "undefined" && typeof t.track == "function"
			},
			r = function (r, i)
			{
				if (!n())
				...
				console.log("track", r), t.track(r, e.extend(i ||
				{},
				{
	...
	}), define("utils/sharing", ["jQuery"], function (e)
	{
		var t = location.href,
			...
			r = {
				twitter: function (e)
				{
					window.open("http://twitter.com/home?status=" + encodeURIComponent(n + " " + t))
				},
				facebook: function (e)
				{
					window.open("http://www.facebook.com/sharer/sharer.php?s=100&p[url]=" + encodeURIComponent(t))
				},
				"google-plus": function (e)
				{
					window.open("https://plus.google.com/share?url=" + encodeURIComponent(t))
				}
			},
			i = function ()
			{
				e(document).on("click", "a[data-sharing]", function (t)
				{
					t && t.preventDefault();
					var n = e(this).data("sharing");
					r[n](e(this))
				})
			};
		return {
	...
	}), define("core/sidebar", ["lodash", "utils/storage", "utils/platform", "core/state"], function (e, t, n, r)
	{
		var i = r.$book.find(".book-summary"),
			s = function (e, n)
			{
				if (r != null && o() == e) return;
				n == null && (n = !0), r.$book.toggleClass("without-animation", !n), r.$book.toggleClass("with-summary", e), t.set("sidebar", o())
			},
			o = function ()
			{
				return r.$book.hasClass("with-summary")
			},
			u = function ()
			{
				...
				{
					e.preventDefault(), s()
				}), n.isMobile || s(t.get("sidebar", !0), !1)
			},
			a = function (t)
			{
				i.find("li").each(function ()
				{
					var n = $(this).data("path"),
						r = t == null || e.contains(t, n);
					$(this).toggle(r), r && $(this).parents("li").show()
				})
			};
		return {
			$el: i,
		...
		var o = null,
			...
			p = function ()
			{
				...
				n.keyup(function (n)
				{
					...
					if (i.length == 0) s.filter(null);
					else
					{
						var o = f(i);
						s.filter(t.pluck(o, "path"))
					}
				})
			};
		return {
	...
	}), define("core/progress", ["lodash", "jQuery", "utils/storage", "core/state"], function (e, t, n, r)
	{
		var i = function ()
			{
				return r.level
	...
	}), define("utils/execute", ["execute/javascript"], function (e)
	{
		var t = {
				javascript: e
			},
			n = function (e, t, n)
			{
				var r = !1,
					...
					s = function ()
					{
						return i ? console.error("Already finished") : (i = !0, n.apply(null, arguments))
					},
					o, u = function (e, n)
					{
						console.log([n, e]);
						...
						case "error":
							...
							return s(new Error(e));
						case "ready":
							r = !0, o.eval(t);
							break;
						default:
							console.log("Unhandled event =", n, "data =", e)
						}
					};
				o = new e.REPL(
				{
				...
				}), o.loadLanguage(e.id, u)
			},
			r = function (e, r, i, s, o)
			{
				var u = t[e];
				if (!u) return o(new Error("Language '" + e + "' not available for execution"));
				var a = [s, r, u.assertCode, i].join(u.sep);
				n(u, a, function (e, t)
				{
					if (e) return o(e);
					t.type == "error" ? o(new Error(t.value)) : o(null, t.value)
				})
			};
		return r
	}), define("core/exercise", ["jQuery", "utils/execute", "utils/analytic", "core/state"], function (e, t, n, r)
	{
		var i = function (e)
			{
				var r = e.find(".code-solution").text(),
					i = e.find(".code-validation").text(),
					s = e.find(".code-context").text(),
					o = ace.edit(e.find(".editor").get(0));
				o.setTheme("ace/theme/tomorrow"), o.getSession().setUseWorker(!1), o.getSession().setMode("ace/mode/javascript"), e.find(".action-submit").click(function (r)
				{
					r.preventDefault(), n.track("exercise.submit",
					{
						type: "code"
					}), t("javascript", o.getValue(), i, s, function (t, n)
					{
						e.toggleClass("return-error", t != null), e.toggleClass("return-success", t == null), t && e.find(".alert-danger").text(t.message || t)
					})
				}), e.find(".action-solution").click(function (e)
				{
					e.preventDefault(), o.setValue(r), o.gotoLine(0)
				})
			},
			s = function ()
			{
				r.$book.find("section.exercise").each(function ()
				{
					i(e(this))
				})
			};
	...
	}), define("core/quiz", ["jQuery", "utils/execute", "utils/analytic", "core/state"], function (e, t, n, r)
	{
		var i = function (t)
			{
				t.find(".quiz-answers input").click(function (e)
				{
					e.preventDefault()
				}), t.find(".action-submit").click(function (r)
				{
					r.preventDefault(), n.track("exercise.submit",
					{
						type: "quiz"
					}), t.find("tr.alert-danger,li.alert-danger").removeClass("alert-danger"), t.find(".alert-success,.alert-danger").addClass("hidden"), t.find(".question").each(function (n)
					{
						var r = !0,
							i = t.find(".question-answers").slice(n).find("input[type=radio], input[type=checkbox]");
						e(this).find("input[type=radio],input[type=checkbox]").each(function (t)
						{
							var n = e(this).is(":checked") === i.slice(t).first().is(":checked");
							r = r && n, n || e(this).closest("tr, li").addClass("alert-danger")
						}), e(this).find(r ? "div.alert-success" : "div.alert-danger").toggleClass("hidden")
					})
				}), t.find(".action-solution").click(function (e)
				{
					e.preventDefault(), t.find(".question-content, .question-answers").toggleClass("hidden")
				})
			},
			s = function ()
			{
				r.$book.find("section.quiz").each(function ()
				{
					i(e(this))
				})
			};
	...
	}), define("core/navigation", ["jQuery", "utils/analytic", "core/state", "core/search", "core/progress", "core/exercise", "core/quiz"], function (e, t, n, r, i, s, o)
	{
		var u, a, f, l, c = function (e, t)
			...
			h = function (t, n)
			{
				...
				return e.get(t).done(function (r)
				{
					r = r.replace(/<(\/?)(html|head|body)([^>]*)>/ig, function (e, t, n, r)
					{
						return "<" + t + "div" + (t ? "" : ' data-element="' + n + '"') + r + ">"
					});
					var i = e(r),
						s = i.find("[data-element=head]"),
						o = s.html();
					e("head style").each(function ()
					{
						o += this.outerHTML
					}), e("head").html(o), e(".book-header").html(i.find(".book-header").html()), e(".book-body").html(i.find(".book-body").html()), e(".book-summary").html(i.find(".book-summary").html()), n && c(t, null), v()
				}).fail(function ()
				{
					location.href = t
				})
			...
			p = function ()
			{
				e(".book-header .count-star span").text(f), e(".book-header .count-watch span").text(l)
			},
			d = function ()
			{
				var t, n;
			...
			v = function ()
			{
				var u = e(".book-body .page-wrapper");
				s.init(), o.init(), i.show(), d(), u.scrollTop(0), u.focus(), r.prepare(), n.githubId && (f ? p() : e.getJSON("https://api.github.com/repos/" + n.githubId).done(function (e)
				{
					f = e.stargazers_count, l = e.subscribers_count, p()
				})), t.track("page.view")
			},
			m = function (t)
			{
			...
			b = function ()
			{
				...
				}, ""), window.onpopstate = function (e)
				{
					...
					return h(e.state.path, !1)
				}, e(document).on("click", ".navigation-prev", m), e(document).on("click", ".navigation-next", m), e(document).on("click", ".summary [data-path] a", m), e(window).resize(d), v()
			};
		return {
			init: b,
			goNext: g,
	...
	}), require(["jQuery", "utils/storage", "utils/analytic", "utils/sharing", "core/state", "core/keyboard", "core/navigation", "core/progress", "core/sidebar", "core/search"], function (e, t, n, r, i, s, o, u, a, f)
	{
		e(document).ready(function ()
		{
			var e;
			e = i.$book, i.githubId && t.setBaseKey(i.githubId), a.init(), f.init(), s.init(), r.init(), o.init()
		})
	}), define("app", function () {});